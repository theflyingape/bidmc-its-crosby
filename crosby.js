...
dns.lookup('0.0.0.0', (err, addr, family) => {
    ...
    app.get('/crosby/devices/', (req, res) => {
        authorize(exports.appClientId, (auth) => {
            let params = { auth: auth, customerId: 'my_customer', fields: 'chromeosdevices(annotatedAssetId,annotatedLocation,annotatedUser,deviceId,ethernetMacAddress,firmwareVersion,lastEnrollmentTime,lastSync,macAddress,meid,model,notes,orgUnitPath,osVersion,platformVersion,serialNumber,status,supportEndDate)'
            };
